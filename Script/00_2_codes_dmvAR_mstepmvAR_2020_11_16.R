# # # # # # # # # # # # # # # # # # # # # # # #
#
# This loads functions for AR1 compatible with mhsmm package
#   (cov.wt, dmvnormAR.hsmm, hsmmspec, mstep.mvAR, rmvnormAR.hsmm,rmvnormAR.hsmm,
#   simulate.hmmspec.mod, simulate.hsmmspec, simulate.hsmmspec.mod)
# and function to manipulate input model and outputs
#   (label.switching, raw.model.builder, vessel.model.builder,
...
#
# m.V.1 : moyennes des variables dans l'?tat 1
# s2.V.1 : variances ; ind?pendance donc pas de covariances ==> vecteur et non matrice 
# mu.V.1 : coefficients des AR1
# m.soj : moyennes de temps de s?jour dans les ?tats ==> vecteur de dimension le nbr d'?tats
#         les unit?s sont en nombre de pas de temps
#
